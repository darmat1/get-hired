  ...
  return (
    <div className="min-h-screen bg-warm-50 dark:bg-warm-950 text-warm-900 dark:text-warm-50">
      ...
      <main className="font-body mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <h1 className="font-heading text-4xl font-bold mb-8 text-warm-900 dark:text-warm-50">Cookie Policy</h1>
        
        <div className="prose dark:prose-invert max-w-none space-y-6">
          <section>
            <h2 className="font-heading text-2xl font-semibold mb-4 text-warm-900 dark:text-warm-50">What Are Cookies</h2>
          ...
          <section>
            <h2 className="font-heading text-2xl font-semibold mb-4 text-warm-900 dark:text-warm-50">Types of Cookies We Use</h2>
          ...
          <section>
            <h2 className="font-heading text-2xl font-semibold mb-4 text-warm-900 dark:text-warm-50">How to Control Cookies</h2>
          ...
          <section>
            <h2 className="font-heading text-2xl font-semibold mb-4 text-warm-900 dark:text-warm-50">Third-Party Cookies</h2>
          ...
          <section>
            <h2 className="font-heading text-2xl font-semibold mb-4 text-warm-900 dark:text-warm-50">Changes to This Policy</h2>
