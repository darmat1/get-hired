...
const themeScript = `(function(){try{const t=localStorage.getItem('get-hired-theme'); if(t==='dark'){ document.documentElement.classList.add('dark'); } else { document.documentElement.classList.remove('dark'); } }catch(e){}})();`;
