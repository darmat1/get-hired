  ...
  return (
    <footer className="border-t border-border bg-background/50">
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="border-t border-border py-8 flex flex-col md:flex-row items-center gap-4">
          <a
            href="https://saasbrowser.com/ru/saas/1460756/gethired"
            target="_blank"
            rel="noopener noreferrer"
          >
            <img
              src="https://static-files.saasbrowser.com/saas-browser-badge-17.svg"
              alt="GetHired - software directory"
              width="200"
            />
          </a>
          <a
        ...
        <div className="border-t border-border pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <a
              href="https://www.reddit.com/r/GetHiredHQ"
              target="_blank"
              rel="noopener noreferrer"
              className="text-muted-foreground hover:text-foreground transition-colors"
              aria-label="Reddit"
