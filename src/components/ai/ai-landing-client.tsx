  ...
  return (
    <div className="min-h-screen bg-white dark:bg-slate-950 flex flex-col">
      ...
      <main className="flex-1">
        {/* HERO */}
        <section className="relative pt-28 pb-12 bg-gradient-to-b from-white to-slate-50 dark:from-slate-900 dark:to-slate-950">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-slate-50 text-slate-600 text-sm font-semibold mb-6 animate-bounce">
                ...
                <p className="text-lg text-slate-600 dark:text-slate-400 mb-6 max-w-xl">
                ...
                <div className="flex gap-4">
                  ...
                  <Link href="/pricing">
                    <button className="rounded-full border border-slate-200 px-6 py-3 text-sm font-medium hover:bg-slate-50 transition dark:border-slate-800 dark:text-slate-300 dark:hover:bg-slate-800/50 dark:hover:text-slate-100">
              ...
              <div className="relative">
                <div className="w-full h-[350px] dark:bg-slate-800 rounded-2xl shadow-lg overflow-hidden flex items-center justify-center animate-pulse object-contain">
                ...
                {/* <div className="mt-4 grid grid-cols-3 gap-3">
                  <div className="h-20 bg-slate-100 dark:bg-slate-800 rounded-lg flex items-center justify-center text-xs text-slate-400 animate-pulse">
        ...
        <section className="py-16">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="p-6 bg-white dark:bg-slate-900 rounded-2xl border border-slate-100 dark:border-slate-800 hover:shadow-lg transition">
                <div className="h-12 w-12 rounded-lg bg-slate-50 dark:bg-slate-800 text-slate-600 dark:text-slate-400 flex items-center justify-center mb-4">
              ...
              <div className="p-6 bg-white dark:bg-slate-800 rounded-2xl border border-slate-100 dark:border-slate-700 hover:shadow-lg transition">
