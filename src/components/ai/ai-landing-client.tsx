      ...
      <main className="flex-1">
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="relative">
                <div className="w-full h-[350px] dark:bg-gray-800 rounded-2xl shadow-lg overflow-hidden flex items-center justify-center animate-pulse object-contain">
                ...
                {/* <div className="mt-4 grid grid-cols-3 gap-3">
                  <div className="h-20 bg-gray-100 dark:bg-gray-800 rounded-lg flex items-center justify-center text-xs text-gray-400 animate-pulse">
        ...
        <section className="py-12">
          <div className="mx-auto max-w-7xl px-6 lg:px-8 text-center">
            <Link href="/resume/new">
              <button className="rounded-full bg-indigo-600 px-8 py-3 text-white font-semibold shadow hover:bg-indigo-500 transition">
