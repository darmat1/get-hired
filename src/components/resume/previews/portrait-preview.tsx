...
export function PortraitPreview({ data, onChange, isEditing }: Props) {
  ...
  const sectionTitleClass = "text-[12px] font-bold mb-1.5 uppercase tracking-wide border-b pb-1";

  return (
    <div
      className="font-sans space-y-4 p-6 bg-white h-full min-h-[1056px] relative group/preview"
    ...
    >
      ...
      {/* Header: name/contact left, avatar right */}
        ...
        <div className="flex-1 min-w-0">
          {isEditing && (
            <button
              ...
              className="text-[10px] text-slate-500 hover:text-slate-800 flex items-center gap-1.5 px-2 py-1 -ml-2 mb-1 rounded-md transition-all hover:bg-slate-100"
          ...
          {((data as any).targetPosition || isEditing) && (
            <div className="mb-1.5 text-[11px] italic text-slate-600">
              {(data as any).targetPosition}
            </div>
          )}
          {contactItems.length > 0 && (
            <div className="flex flex-wrap items-center gap-x-3 gap-y-0.5 text-slate-700 text-[10px]">
      ...
      <div>
        <h2
          ...
          style={{ color: "#111827", borderColor: accentColor }}
        >
      ...
      {workExperience && (
        <div>
          <div className="flex justify-between items-end mb-2">
            <h2 className={cn(sectionTitleClass, "flex-1")} style={{ color: "#111827", borderColor: accentColor }}>
              {getTranslation("form.work_experience", data.language || "en")}
            </h2>
            {isEditing && (
              <div className="flex gap-2 ml-4 mb-1.5">
                <button
                  onClick={() => {
        ...
        <div className="flex justify-between items-end mb-2">
          ...
          {isEditing && (
            <button
              ...
              className="text-[9px] text-slate-500 hover:text-slate-800 flex items-center gap-1 px-1.5 py-0.5 rounded transition-colors hover:bg-slate-100 ml-4 mb-1.5"
            >
              <Plus size={10} /> Add
            </button>
          )}
          ...
          return (
            <div key={cat}>
              <div className="flex justify-between items-end mb-2">
                ...
                {isEditing && (
                  <div className="flex gap-1 ml-4 mb-1.5">
                    <button
                      onClick={() => {
