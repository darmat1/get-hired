...
export function SymmetryPreview({ data, onChange, isEditing }: Props) {
  ...
  return (
    ...
    >
      ...
      {/* Header - fully centered/symmetric */}
      <div className="relative pb-4">
        ...
        <div className="flex flex-col items-center text-center">
          ...
          {headerContacts.length > 0 && (
            <div className="flex flex-wrap justify-center items-center gap-x-3 gap-y-1 mt-3 text-slate-700 text-[11px]">
          ...
          {profileLinks.length > 0 && (
            <div className="flex flex-wrap justify-center items-center gap-x-3 gap-y-1 mt-1.5 text-[11px]">
      ...
      {/* Summary */}
      <div>
        <h2 className="text-[12px] font-bold mb-1.5 uppercase border-b border-slate-300 pb-0.5 text-slate-900">
      ...
      {workExperience && (
        <div>
          <div className="flex justify-between items-end mb-2 border-b border-slate-300 pb-0.5">
            <h2 className="text-[12px] font-bold uppercase text-slate-900">
      ...
      {/* Skills: technical + soft combined, separate Languages */}
