...
export function FramedPreview({ data, onChange, isEditing }: Props) {
  ...
  return (
    <div className="font-sans bg-white h-full min-h-[1056px] relative group/preview">
      ...
      <div
        className="relative px-7 pt-6 pb-4"
      ...
      >
        ...
        {isEditing && (
          <button
            ...
            className="absolute top-4 right-16 text-[10px] text-slate-500 hover:text-slate-800 flex items-center gap-1.5 px-2 py-1 rounded-md transition-all hover:bg-slate-100"
        ...
        <div className="flex items-center gap-5">
          ...
          <div className="min-w-0">
            <div className="text-[38px] font-extrabold leading-none tracking-tight text-slate-900">
              <div className="inline-flex flex-nowrap items-center gap-3 whitespace-nowrap">
                <EditableText
        ...
        {headerContacts.length > 0 && (
          <div className="flex flex-wrap items-center gap-x-4 gap-y-1 mt-3 text-slate-700 text-[10px]">
                  ...
                  <div className="flex justify-between items-start">
                    <div className="flex-1 pr-4">
                      <EditableText
                        value={cert.name || ""}
                        onChange={(v) =>
                          updateCertificateField(idx, "name", v)
                        }
                        className="font-bold text-slate-900 text-[11px]"
                      ...
                      <EditableText
                        ...
                        className="text-slate-700 text-[10px] italic block"
                        placeholder="Issuer"
                      />
                      {(isEditing || cert.url) && (
                        <EditableText
                    ...
                    <div className="shrink-0 text-right text-[10px] text-slate-600 w-[80px]">
                      <EditableText
                        value={cert.date || ""}
                        onChange={(v) =>
                          updateCertificateField(idx, "date", v)
                        }
                        placeholder="Date"
                        className="text-right w-full"
                      />
