...
export function Modal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      {/* Modal */}
      <div
        className={`relative z-10 w-full mx-4 bg-warm-100 dark:bg-warm-800 rounded-xl shadow-2xl animate-in fade-in zoom-in-95 duration-200 flex flex-col max-h-[90vh] ${
          maxWidth === "sm"
            ? "max-w-sm"
            : maxWidth === "lg"
              ? "max-w-lg"
      ...
      >
        ...
        <div className="flex items-center justify-between p-4 border-b border-warm-200 dark:border-warm-700">
          ...
          <button
            onClick={onClose}
            className="p-1 rounded-lg hover:bg-warm-200 dark:hover:bg-warm-700 transition-colors"
          >
            <svg
