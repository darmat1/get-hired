...
export function LayeredTemplate({ resume }: TemplateProps) {
  ...
  return (
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.tierContact}>
          {contactItems.map((item, i) => (
            <View key={i} style={styles.contactItem}>
              {item.type === "email" && (
                <Svg viewBox="0 0 24 24" width="10" height="10" style={{ marginRight: 3 }}>
                  <Path
                    fill="#ffffff"
            ...
            {personalInfo.summary && (
              <View>
                ...
                <FormattedText
                  ...
                  style={{ textAlign: "justify", fontSize: 9.5 }}
                />
              </View>
            )}
              ...
              <View>
                ...
                <View style={{ flexDirection: "row", flexWrap: "wrap" }}>
                  {skills
                    ...
                    .map((skill, index) => (
                      <Text key={index} style={styles.sidebarTag}>
                        {skill.name}
                      </Text>
                    ))}
                </View>
            ...
            {skills.some((s) => s.category === "language") && (
              <View>
                ...
                {skills
                  ...
                  .map((skill, index) => (
                    <Text key={index} style={{ fontSize: 8.5, marginBottom: 3 }}>
                      {skill.name}
