...
export const translations: Translations = {
  ...
  'page.home.title': { en: 'GetHired - Create Professional Resumes', uk: 'GetHired - Створення професійних резюме', ru: 'GetHired - Создание профессиональных резюме' },
  ...
  'nav.cover_letter': { en: 'Cover Letter', uk: 'Супровідний лист', ru: 'Сопроводительное письмо' },

  // Cover Letter Page
  'cover_letter.title': { en: 'Cover Letter Generator', uk: 'Генератор супровідних листів', ru: 'Генератор сопроводительных писем' },
  'cover_letter.subtitle': { en: 'Generate personalized cover letters based on job descriptions', uk: 'Генеруйте персоналізовані супровідні листи на основі описів вакансій', ru: 'Генерируйте персонализированные сопроводительные письма на основе описания вакансий' },
  'cover_letter.job_description': { en: 'Job Description', uk: 'Опис вакансії', ru: 'Описание вакансии' },
  'cover_letter.paste_job_description': { en: 'Paste job description', uk: 'Вставте опис вакансії', ru: 'Вставьте описание вакансии' },
  'cover_letter.job_description_placeholder': { en: 'Paste the full job description here...', uk: 'Вставте повний опис вакансії тут...', ru: 'Вставьте полное описание вакансии здесь...' },
  'cover_letter.generate': { en: 'Generate Cover Letter', uk: 'Згенерувати супровідний лист', ru: 'Сгенерировать сопроводительное письмо' },
  'cover_letter.generated': { en: 'Generated Cover Letter', uk: 'Згенерований супровідний лист', ru: 'Сгенерированное сопроводительное письмо' },
  'cover_letter.copy': { en: 'Copy', uk: 'Копіювати', ru: 'Копировать' },
  'cover_letter.copied': { en: 'Copied!', uk: 'Скопійовано!', ru: 'Скопировано!' },
  'cover_letter.error.enter_job_description': { en: 'Please paste job description', uk: 'Будь ласка, вставте опис вакансії', ru: 'Пожалуйста, вставьте описание вакансии' },
  'cover_letter.error.generation_failed': { en: 'Error generating cover letter', uk: 'Помилка при генеруванні супровідного листа', ru: 'Ошибка при генерировании сопроводительного письма' },
  'cover_letter.success.generated': { en: 'Cover letter generated successfully', uk: 'Супровідний лист успішно згенерований', ru: 'Сопроводительное письмо успешно сгенерировано' },
  ...
  // LinkedIn Import
  'resume.import_from_linkedin': { en: 'Import from LinkedIn', uk: 'Імпортувати з LinkedIn', ru: 'Импортировать из LinkedIn' },
  'resume.importing': { en: 'Importing...', uk: 'Імпортування...', ru: 'Импортирование...' },
  'resume.error.no_linkedin_connected': { en: 'LinkedIn not connected. Please sign in with LinkedIn first.', uk: 'LinkedIn не підключений. Будь ласка, спочатку увійдіть за допомогою LinkedIn.', ru: 'LinkedIn не подключен. Пожалуйста, сначала войдите через LinkedIn.' },
  'resume.error.linkedin_import_failed': { en: 'Failed to import profile from LinkedIn', uk: 'Не вдалося імпортувати профіль з LinkedIn', ru: 'Не удалось импортировать профиль из LinkedIn' },
  'resume.success.linkedin_imported': { en: 'Profile imported successfully from LinkedIn', uk: 'Профіль успішно імпортовано з LinkedIn', ru: 'Профиль успешно импортирован из LinkedIn' },

  // Footer
  'footer.about': { en: 'About Us', uk: 'Про нас', ru: 'О нас' },
  'footer.about_text': { en: 'GetHired helps you create professional resumes with AI-powered recommendations and LinkedIn integration.', uk: 'GetHired допомагає вам створювати професійні резюме за допомогою рекомендацій AI та інтеграції з LinkedIn.', ru: 'GetHired помогает вам создавать профессиональные резюме с помощью рекомендаций AI и интеграции с LinkedIn.' },
  'footer.legal': { en: 'Legal', uk: 'Юридичне', ru: 'Юридическое' },
  'footer.privacy_policy': { en: 'Privacy Policy', uk: 'Політика приватності', ru: 'Политика конфиденциальности' },
  'footer.terms_of_service': { en: 'Terms of Service', uk: 'Умови користування', ru: 'Условия использования' },
  'footer.cookie_policy': { en: 'Cookie Policy', uk: 'Політика щодо печива', ru: 'Политика в отношении печенья' },
  'footer.contact': { en: 'Contact', uk: 'Контакти', ru: 'Контакты' },
  'footer.contact_email': { en: 'support@gethired.work', uk: 'support@gethired.work', ru: 'support@gethired.work' },
  'footer.copyright': { en: 'GetHired. All rights reserved.', uk: 'GetHired. Усі права захищені.', ru: 'GetHired. Все права защищены.' },

  // Privacy Policy
  'privacy.section1_title': { en: 'Introduction', uk: 'Вступ', ru: 'Введение' },
  'privacy.section1_text': { en: 'We are committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our website and services.', uk: 'Ми прихильні до захисту вашої приватності. Ця Політика приватності пояснює, як ми збираємо, використовуємо, розкриваємо та захищаємо вашу інформацію при використанні нашого веб-сайту та послуг.', ru: 'Мы привержены защите вашей конфиденциальности. Данная Политика конфиденциальности объясняет, как мы собираем, используем, раскрываем и защищаем вашу информацию при использовании нашего веб-сайта и услуг.' },
  'privacy.section2_title': { en: 'Information We Collect', uk: 'Інформація, яку ми збираємо', ru: 'Информация, которую мы собираем' },
  'privacy.section2_text': { en: 'We collect information you provide directly (such as email, resume data, and profile information) and information collected automatically (such as log data and cookies). We may also collect information from LinkedIn when you connect your account.', uk: 'Ми збираємо інформацію, яку ви надаєте безпосередньо (наприклад, електронну пошту, дані резюме та інформацію профілю) та інформацію, зібрану автоматично (наприклад, дані журналу та файли cookie). Ми також можемо збирати інформацію з LinkedIn при підключенні вашого облікового запису.', ru: 'Мы собираем информацию, которую вы предоставляете напрямую (такую как электронная почта, данные резюме и информацию профиля) и информацию, собранную автоматически (такую как данные журнала и файлы cookie). Мы также можем собирать информацию из LinkedIn при подключении вашего аккаунта.' },
  'privacy.section3_title': { en: 'How We Use Your Information', uk: 'Як ми використовуємо вашу інформацію', ru: 'Как мы используем вашу информацию' },
  'privacy.section3_text': { en: 'We use your information to provide, maintain, and improve our services, to process transactions, to send you service updates, and to comply with legal obligations.', uk: 'Ми використовуємо вашу інформацію для надання, обслуговування та вдосконалення наших послуг, обробки операцій, надсилання вам оновлень послуг та відповідності юридичним зобов\'язанням.', ru: 'Мы используем вашу информацию для предоставления, поддержки и улучшения наших услуг, обработки транзакций, отправки вам обновлений услуг и соблюдения юридических обязательств.' },
  'privacy.section4_title': { en: 'Data Security', uk: 'Безпека даних', ru: 'Безопасность данных' },
  'privacy.section4_text': { en: 'We implement appropriate technical and organizational measures to protect your personal information against unauthorized access, alteration, disclosure, or destruction. However, no method of transmission over the internet is 100% secure.', uk: 'Ми впроваджуємо відповідні технічні та організаційні заходи для захисту вашої особистої інформації від несанкціонованого доступу, зміни, розкриття або знищення. Однак жоден спосіб передачі через Інтернет не є 100% безпечним.', ru: 'Мы принимаем надлежащие технические и организационные меры для защиты вашей личной информации от несанкционированного доступа, изменения, раскрытия или уничтожения. Однако никакой способ передачи через Интернет не является 100% безопасным.' },
  'privacy.section5_title': { en: 'Your Rights', uk: 'Ваші права', ru: 'Ваши права' },
  'privacy.section5_text': { en: 'You have the right to access, correct, or delete your personal information. You can manage your preferences in your account settings or contact us for assistance.', uk: 'У вас є право на доступ, виправлення або видалення вашої особистої інформації. Ви можете керувати своїми параметрами в налаштуваннях облікового запису або звернутися до нас за допомогою.', ru: 'Вы имеете право на доступ, исправление или удаление вашей личной информации. Вы можете управлять своими предпочтениями в настройках учетной записи или связаться с нами для получения помощи.' },
  'privacy.section6_title': { en: 'Contact Us', uk: 'Зв\'яжіться з нами', ru: 'Свяжитесь с нами' },
  'privacy.section6_text': { en: 'If you have questions about this Privacy Policy or our privacy practices, please contact us at support@gethired.work.', uk: 'Якщо у вас є запитання щодо цієї Політики приватності або наших методів захисту приватності, будь ласка, зв\'яжіться з нами за адресою support@gethired.work.', ru: 'Если у вас есть вопросы о данной Политике конфиденциальности или наших методах защиты конфиденциальности, пожалуйста, свяжитесь с нами по адресу support@gethired.work.' },

  // Terms of Service
  'terms.section1_title': { en: 'Agreement to Terms', uk: 'Погодження з Умовами', ru: 'Согласие с условиями' },
  'terms.section1_text': { en: 'By accessing and using GetHired, you accept and agree to be bound by the terms and provision of this agreement. If you do not agree to abide by the above, please do not use this service.', uk: 'Отримавши доступ та використовуючи GetHired, ви приймаєте та погоджуєтесь бути пов\'язані умовами та положеннями цієї угоди. Якщо ви не згодні дотримуватися вищевказаного, будь ласка, не користуйтеся цією послугою.', ru: 'Получая доступ и используя GetHired, вы принимаете и соглашаетесь соблюдать условия и положения данного соглашения. Если вы не согласны соблюдать вышеизложенное, пожалуйста, не используйте эту услугу.' },
  'terms.section2_title': { en: 'Use License', uk: 'Ліцензія на використання', ru: 'Лицензия на использование' },
  'terms.section2_text': { en: 'Permission is granted to temporarily download one copy of the materials (information or software) on GetHired for personal, non-commercial transitory viewing only. This is the grant of a license, not a transfer of title, and under this license you may not: modify the materials, copy the materials, use the materials for any commercial purpose or for any public display, attempt to decompile or reverse engineer any software contained on the service, transfer the materials to another person, or replicate the materials on any other server.', uk: 'Надається дозвіл на тимчасове завантаження однієї копії матеріалів (інформації або програмного забезпечення) на GetHired виключно для особистого, некомерційного тимчасового перегляду. Це надання ліцензії, а не передача прав власності, і при цій ліцензії ви не можете: змінювати матеріали, копіювати матеріали, використовувати матеріали в будь-яких комерційних цілях або для публічного показу, намагатися декомпілювати або зворотньо розробляти будь-яке програмне забезпечення, розміщене на послузі, передавати матеріали іншій особі або повторювати матеріали на будь-якому іншому сервері.', ru: 'Дается разрешение на временное загрузку одной копии материалов (информации или программного обеспечения) на GetHired исключительно для личного, некоммерческого временного просмотра. Это предоставление лицензии, а не передача прав собственности, и в соответствии с этой лицензией вы не можете: изменять материалы, копировать материалы, использовать материалы в любых коммерческих целях или для публичного отображения, пытаться декомпилировать или обратно разрабатывать любое программное обеспечение, содержащееся на сервисе, передавать материалы другому лицу или тиражировать материалы на любом другом сервере.' },
  'terms.section3_title': { en: 'Disclaimer', uk: 'Відмова від відповідальності', ru: 'Отказ от ответственности' },
  'terms.section3_text': { en: 'The materials on GetHired are provided on an \'as is\' basis. GetHired makes no warranties, expressed or implied, and hereby disclaims and negates all other warranties including, without limitation, implied warranties or conditions of merchantability, fitness for a particular purpose, or non-infringement of intellectual property or other violation of rights.', uk: 'Матеріали на GetHired надаються на основі "як є". GetHired не дає жодних гарантій, виражених або передбачених, і цим відмовляється від усіх інших гарантій, включаючи, без обмеження, передбачені гарантії або умови товарозвичайності, придатності для конкретної мети або неанаповідальності за порушення прав інтелектуальної власності або інші порушення прав.', ru: 'Материалы на GetHired предоставляются "как есть". GetHired не дает никаких гарантий, ни явных, ни подразумеваемых, и настоящим отказывается от всех других гарантий, включая, без ограничения, подразумеваемые гарантии или условия товарной пригодности, пригодности для конкретной цели или неправомерности нарушения прав интеллектуальной собственности или других нарушений прав.' },
  'terms.section4_title': { en: 'Limitations of Liability', uk: 'Обмеження відповідальності', ru: 'Ограничение ответственности' },
  'terms.section4_text': { en: 'In no event shall CV Maker or its suppliers be liable for any damages (including, without limitation, damages for loss of data or profit, or due to business interruption) arising out of the use or inability to use the materials on CV Maker.', uk: 'CV Maker та його постачальники ні за яких обставин не несуть відповідальності за будь-які збитки (включаючи, без обмеження, збитки за втрату даних або прибутку, або через перебої в роботі) що виникають з використання або неможливості використання матеріалів на CV Maker.', ru: 'CV Maker и его поставщики при всех обстоятельствах не несут ответственности за любые убытки (включая, без ограничения, убытки от потери данных или прибыли либо из-за перебоев в работе), возникающие в результате использования или невозможности использования материалов на CV Maker.' },
  'terms.section5_title': { en: 'Accuracy of Materials', uk: 'Точність матеріалів', ru: 'Точность материалов' },
  'terms.section5_text': { en: 'The materials appearing on CV Maker could include technical, typographical, or photographic errors. CV Maker does not warrant that any of the materials on its website are accurate, complete, or current. CV Maker may make changes to the materials contained on its website at any time without notice.', uk: 'Матеріали, що з\'являються на CV Maker, можуть включати технічні, типографічні або фотографічні помилки. CV Maker не гарантує, що будь-які матеріали на його веб-сайті є точними, повними або поточними. CV Maker може змінювати матеріали на своєму веб-сайті в будь-який час без повідомлення.', ru: 'Материалы, отображаемые на CV Maker, могут содержать технические, типографические или фотографические ошибки. CV Maker не гарантирует, что какие-либо материалы на его веб-сайте являются точными, полными или актуальными. CV Maker может вносить изменения в материалы на своем веб-сайте в любое время без уведомления.' },
  'terms.section6_title': { en: 'Links', uk: 'Посилання', ru: 'Ссылки' },
  'terms.section6_text': { en: 'CV Maker has not reviewed all of the sites linked to its website and is not responsible for the contents of any such linked site. The inclusion of any link does not imply endorsement by CV Maker of the site. Use of any such linked website is at the user\'s own risk.', uk: 'CV Maker не переглядав всі сайти, пов\'язані з його веб-сайтом, і не несе відповідальності за зміст жодного такого пов\'язаного сайту. Включення будь-якого посилання не означає схвалення CV Maker сайту. Використання будь-якого такого пов\'язаного веб-сайту здійснюється на ризик користувача.', ru: 'CV Maker не просмотрел все сайты, связанные с его веб-сайтом, и не несет ответственности за содержание какого-либо такого связанного сайта. Включение любой ссылки не подразумевает одобрение CV Maker сайта. Использование любого такого связанного веб-сайта происходит на риск пользователя.' },

  // Cookie Policy
  'cookies.section1_title': { en: 'What Are Cookies', uk: 'Що таке печива', ru: 'Что такое печенье' },
  'cookies.section1_text': { en: 'Cookies are small pieces of data stored on your device when you visit our website. They help us remember your preferences, maintain your session, and analyze how you use our service. Some cookies are essential for the site to function, while others help us improve your experience.', uk: 'Печива - це невеликі фрагменти даних, збережені на вашому пристрої при відвідуванні нашого веб-сайту. Вони допомагають нам запам\'ятовувати ваші переваги, підтримувати вашу сесію та аналізувати, як ви користуєтеся нашою послугою. Деякі печива є важливими для функціонування сайту, тоді як інші допомагають нам вдосконалити вашу роботу.', ru: 'Печенье - это небольшие фрагменты данных, хранящиеся на вашем устройстве при посещении нашего веб-сайта. Они помогают нам запомнить ваши предпочтения, поддерживать ваш сеанс и анализировать, как вы используете нашу услугу. Некоторое печенье необходимо для работы сайта, тогда как другое помогает нам улучшить ваш опыт.' },
  'cookies.section2_title': { en: 'Types of Cookies We Use', uk: 'Типи печива, які ми використовуємо', ru: 'Типы печенья, которые мы используем' },
  'cookies.section2_text': { en: 'Essential Cookies: Required for the site to function properly (authentication, security). Analytics Cookies: Help us understand how users interact with our site. Preference Cookies: Remember your language and theme settings. Marketing Cookies: Used to track your activity and show relevant content.', uk: 'Необхідні печива: Необхідні для належного функціонування сайту (автентифікація, безпека). Аналітичні печива: Допомагають нам зрозуміти, як користувачі взаємодіють з нашим сайтом. Печива для переваг: Запам\'ятовують ваші мовні та теми налаштування. Маркетингові печива: Використовуються для відстеження вашої діяльності та відображення відповідного змісту.', ru: 'Важное печенье: Требуется для правильной работы сайта (аутентификация, безопасность). Аналитическое печенье: Помогает нам понять, как пользователи взаимодействуют с нашим сайтом. Печенье для предпочтений: Запомните ваши языковые и темные настройки. Маркетинговое печенье: Используется для отслеживания вашей активности и показа соответствующего контента.' },
  'cookies.section3_title': { en: 'How to Control Cookies', uk: 'Як контролювати печива', ru: 'Как контролировать печенье' },
  'cookies.section3_text': { en: 'Most web browsers allow you to control cookies through their settings. You can choose to accept all cookies, refuse all cookies, or be notified when a cookie is sent. Note that disabling essential cookies may affect the functionality of our website.', uk: 'Більшість веб-браузерів дозволяють вам керувати печивом через його параметри. Ви можете вибрати прийняття всіх печива, відмову від усіх печива або отримання повідомлення при відправленні печива. Зверніть увагу, що вимкнення необхідних печива може вплинути на функціональність нашого веб-сайту.', ru: 'Большинство веб-браузеров позволяют вам контролировать печенье через его настройки. Вы можете выбрать принять все печенье, отказать во всех печеньях или получить уведомление при отправке печенья. Обратите внимание, что отключение важного печенья может повлиять на функциональность нашего веб-сайта.' },
  'cookies.section4_title': { en: 'Third-Party Cookies', uk: 'Печива третіх сторін', ru: 'Печенье третьих сторон' },
  'cookies.section4_text': { en: 'We may use third-party services that set cookies on your device, such as analytics providers and authentication services (LinkedIn, Google). These services have their own privacy policies and cookie practices.', uk: 'Ми можемо використовувати сторонні послуги, які встановлюють печива на вашому пристрої, такі як постачальники аналітики та послуги автентифікації (LinkedIn, Google). Ці послуги мають свої власні політики приватності та практики щодо печива.', ru: 'Мы можем использовать сторонние сервисы, которые устанавливают печенье на вашем устройстве, такие как поставщики аналитики и услуги аутентификации (LinkedIn, Google). Эти сервисы имеют свои собственные политики конфиденциальности и практики использования печенья.' },
  'cookies.section5_title': { en: 'Changes to This Policy', uk: 'Зміни до цієї політики', ru: 'Изменения в этой политике' },
  'cookies.section5_text': { en: 'We may update this Cookie Policy from time to time to reflect changes in our practices or for other operational, legal, or regulatory reasons. We will notify you of any material changes by updating the date of this policy.', uk: 'Ми можемо оновлювати цю Політику щодо печива час від часу, щоб відобразити зміни в наших практиках або з інших операційних, юридичних чи нормативних причин. Ми повідомимо вас про будь-які матеріальні зміни, оновивши дату цієї політики.', ru: 'Мы можем обновлять данную Политику в отношении печенья время от времени, чтобы отразить изменения в нашей практике или по другим операционным, юридическим или нормативным причинам. Мы уведомим вас о любых существенных изменениях, обновив дату этой политики.' },
}
